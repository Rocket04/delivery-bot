...
- [Инструкция деплоя на VPS (Stage 6)](docs/DEPLOY.md)
...
- [x] Stage 5 — полировка и тесты ✅ (27 тестов, фидбек-раунд закрыт)
- [ ] Stage 6 — деплой и бета (подготовка: Dockerfile, compose, бэкапы, DEPLOY.md)